...
[+]
 ...
 |  v.2"""
print W+R+" |\n[+]"+W+" Tittle   : "+O+"WebShell Scanner\n"+W+R+"[+]"+W+" Coded By : "+O+"a2svs"
print W+R+"[+]"+W+" Github   :"+O+" https://github.com/a2svs"
print W+R+"[+]"+W+" Contact's :"+O+" @a2svs "
...
if "1" in menu:
	...
	print("""
	Coded By a2svs
	https://facebook.com/a2svs
	https://instagram.com/a2svs
	https://twitter.com/a2svs
	https://t.me/a2svs
	https://www.threads.net/@a2svs
	""")
elif "4" in menu:
	exit("[*] Bye")
